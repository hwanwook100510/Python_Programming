...
p1 = (1, 2, 3)
p2 = (10, 20, 30)
result1 = tuple(a + b for a, b in zip(p1, p2))
print(result)
...
print(f"{days[hours.index(max(hours))]}요일")                                                    # ✅ 6시간
...
print(f"max 점수: {result[-1]}점 min 점수: {result[0]}")                                                    # ✅ max 점수: 92점, min 점수: 76점
...
total1 = sum(price * qty for _, price, qty in zip(*stocks))
